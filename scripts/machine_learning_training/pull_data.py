...
from configs.config import DB_CONFIG, TRAINING_DIR
...
def pull_data(**context):
    ...
    """
    # Define the base directory for saving the training data
    training_data_dir = TRAINING_DIR
    raw_data_dir = os.path.join(training_data_dir, "raw")  # New subdirectory for raw data
