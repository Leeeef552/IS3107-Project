...
from configs.config import PREDICTION_DIR
...
def preprocess_data(time_bin="1hr", **context):
    ...
    xcom_paths = ti.xcom_pull(task_ids='pull_data', key='pulled_data_paths')
    ...
    intermediate_data_dir = os.path.join(prediction_data_dir, "preprocessed")
